...
export class AcquisitionFormComponent extends BaseSection {
    ...
    constructor(page: Page) {
        ...
        this.lastNameInput = page.locator('input[name="osde-cap-last-name"]');
        this.documentTypeSelect = page.locator('select[name="docType"]');
        this.documentNumberInput = page.locator('input[name="numDoc"]');
        this.codAreaInput = page.locator('input[name="codArea"]');
