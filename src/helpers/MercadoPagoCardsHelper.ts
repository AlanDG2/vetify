import { MERCADOPAGO_CREDIT_CARDS, MERCADOPAGO_DEBIT_CARDS } from '@constants/mercadoPagoCardProviders';
import { MERCADOPAGO_PAYMENT_STATUSES } from '@constants/mercadoPagoPaymentStatuses';
import type {
  MercadoPagoCheckoutPaymentData,
  MercadoPagoPaymentStatusCode,
  MercadoPagoCard,
  MercadoPagoCardBrand,
} from '@models/mercadoPago';
...
export class MercadoPagoCardsHelper {
  ...
  static buildCheckoutPaymentData(
    statusCode: MercadoPagoPaymentStatusCode,
    brand: MercadoPagoCardBrand = 'visa',
  ): MercadoPagoCheckoutPaymentData {
