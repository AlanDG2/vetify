...
test.describe.skip('Videollamadas Test Suite', () => {
    ...
    test.describe.skip('TS-01 Iniciar flujo', () => {
        test('CP-01 - Iniciar flujo desde home', { tag: ['@critical'] }, async ({ homePage, videocallFormPage }) => {
            await setAllureDetails({
                preconditions: ['Iniciar sesión con un usuario adquiriente'],
            ...
            await step('Navegar a la pantalla de solicitud de videollamada', async () => {
                await Promise.all([
                    ...
                    videocallFormPage.waitForPageLoaded(),
                ]);
            });

            await step('Validar que la página se cargó correctamente', async () => {
                // Validate that the page loaded
                expect(videocallFormPage.pageTitle).toBeVisible();
                expect(videocallFormPage.pageTitle).toHaveText('Detalles para la asistencia');
            });
        });

        test('CP-02 - Iniciar flujo desde página de servicios', { tag: ['@critical'] }, async ({ servicesPage, videocallFormPage }) => {
            await setAllureDetails({
                preconditions: ['Iniciar sesión con un usuario adquiriente'],
        ...
        test('CP-03 - Iniciar flujo desde side-panel', { tag: ['@critical'] }, async ({ homePage, videocallFormPage }) => {
            await setAllureDetails({
                preconditions: ['Iniciar sesión con un usuario adquiriente'],
    ...
    test.describe('TS-02 Agendar Videollamada - Paso 1', () => {
        ...
        test('CP-01 - Listar mascotas - Sin Mascotas', async () => {
            await setAllureDetails({
                preconditions: ['Iniciar sesión con un usuario adquiriente sin mascota cargadas', 'El usuario se encuentra en la página de "Solicitar Videollamada"'],
        ...
        test('CP-03 - Listar mascotas - 1 Mascota', async () => {
            await setAllureDetails({
                preconditions: [
                    'Iniciar sesión con un usuario adquiriente',
        ...
        test('CP-04 - Listar mascotas - Multiples mascotas', { tag: ['@critical'] }, async ({ page }) => {
            ...
            await step('Obtener listado de mascotas desde la API', async () => {
                const vetifyApiClient = await VetifyWebappApiClient.getApiClient(page);
    ...
    test.describe('TS-03 Agendar Videollamada - Paso 2', () => {
        ...
        test('CP-01 - Adjuntar archivo', { tag: ['@critical'] }, async () => {
            await setAllureDetails({
                preconditions: ['Iniciar sesión con un usuario adquiriente', 'Usuario con al menos un plan activo', 'El usuario tiene al menos una mascota cargada'],
    ...
    test.describe.skip('TS-04 Videollamadas agendadas', () => {
        ...
        test.beforeAll(async ({ browser }) => {
            ...
            vetifyApiClient = await VetifyWebappApiClient.getApiClient(page);
        ...
        test('CP-01 - Listado en la Home - Una videollamada', { tag: ['@critical'] }, async ({ page }) => {
            ...
            await setAllureDetails({
                preconditions: ['Iniciar sesión con un usuario adquiriente', 'Usuario tiene una única videollamada agendada'],
        ...
        test('CP-02 - Listado en la Home - Multiples videollamadas', { tag: ['@critical'] }, async ({ page }) => {
            await setAllureDetails({
                preconditions: ['Iniciar sesión con un usuario adquiriente', 'Usuario tiene más de una videollamada agendada'],
                steps: ['Ingresar a la pantalla de Home'],
                expectedResult: [
        ...
        test('CP-03 - Videollamadas - Ver', { tag: ['@critical'] }, async ({ page }) => {
            await setAllureDetails({
                preconditions: ['Iniciar sesión con un usuario adquiriente', 'Usuario con al menos un plan activo', 'El usuario tiene al menos una mascota cargada'],
    ...
    test.describe('TS-05 Editar Videollamada', () => {
        ...
        test('CP-02 - Editar - Reprogramar', { tag: ['@critical'] }, async ({ page }) => {
            await setAllureDetails({
                preconditions: ['Iniciar sesión con un usuario adquiriente', 'El usuario tiene al menos una videollamada agendada a una fecha futura'],
                steps: [
        ...
        test('CP-04 - Editar - Cambiar adjunto - Sin Archivo Adjunto previo', async () => {
            await setAllureDetails({
                preconditions: ['Iniciar sesión con un usuario adquiriente', 'El usuario tiene al menos una videollamada agendada a una fecha futura sin archivo adjunto'],
        ...
        test('CP-05 - Editar - Cambiar adjunto - Con Archivo Adjunto existente', async () => {
            await setAllureDetails({
                preconditions: ['Iniciar sesión con un usuario adquiriente', 'El usuario tiene al menos una videollamada agendada a una fecha futura con archivo adjunto'],
        ...
        test('CP-06 - Editar - Cancelar modificaciones', async () => {
            await setAllureDetails({
                preconditions: [
                    'Iniciar sesión con un usuario adquiriente',
                    'El usuario tiene al menos una videollamada agendada',
